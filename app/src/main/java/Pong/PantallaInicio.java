...
public class PantallaInicio extends JFrame {
    ...
    public PantallaInicio() {
        ...
        try {
            imagenFondo = ImageIO.read(new File("CircusCharlie/app/src/main/java/Pong/imagenes/Pong.gif"));
        } catch (IOException e) {
            e.printStackTrace();
        }  
        ...
        JLabel configuracion = new JLabel("<html><h1>Configuración</h1></html>", SwingConstants.CENTER);
